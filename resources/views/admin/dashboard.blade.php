        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
            <div class="bg-white p-8 rounded-2xl shadow-md flex items-center justify-between group hover:shadow-xl transition-all duration-300">
                <div>
                    ...
                    <h3 id="totalFaculty" class="text-4xl font-black text-[#800000] mt-1">0</h3>
                    <p class="text-gray-400 text-[10px] mt-1">Registered Professors</p>
                </div>
            ...
            <div class="bg-white p-8 rounded-2xl shadow-md flex items-center justify-between group hover:shadow-xl transition-all duration-300">
                <div>
                    ...
                    <h3 id="totalStudents" class="text-4xl font-black text-gray-800 mt-1">0</h3>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div class="lg:col-span-2 bg-white rounded-2xl shadow-md border border-gray-100 overflow-hidden">
                <div class="bg-[#800000] px-6 py-4 flex justify-between items-center text-white">
                    <h4 class="font-bold text-sm uppercase tracking-wider"> Evaluation Feed</h4>
...
<script>
    // --- 1. MOCK DATA (Synced with Departments Logic) ---
    // These arrays represent your database. The numbers on the cards come from here.
    let facultyList = [
        { id: 'FAC-001', name: 'Dr. Rogelio Reyes' },
        { id: 'FAC-002', name: 'Dr. Sarah Santos' },
        { id: 'FAC-003', name: 'Prof. John Doe' }
    ];

    let studentList = [
        { id: '2023-00123-MN-0', name: 'Dela Cruz, Juan' },
        { id: '2023-00124-MN-0', name: 'Rizal, Jose' },
        { id: '2023-00125-MN-0', name: 'Bonifacio, Andres' },
        { id: '2023-00126-MN-0', name: 'Silang, Gabriela' }
    ];

    // --- 2. UPDATE DASHBOARD COUNTS ON LOAD ---
    document.addEventListener('DOMContentLoaded', function() {
        // Calculate totals
        const totalFaculty = facultyList.length;
        const totalStudents = studentList.length;

        // Update the DOM elements with IDs we added
        document.getElementById('totalFaculty').innerText = totalFaculty;
        document.getElementById('totalStudents').innerText = totalStudents.toLocaleString(); // Adds commas if number is large
    });


    // --- 3. UI INTERACTION LOGIC (Password, Modals, Etc) ---
