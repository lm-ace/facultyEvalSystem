...
<section class="relative h-[50vh] bg-cover bg-center" style="background-image: url('{{ asset('images/lagoon.jpg') }}');">
    <div class="absolute inset-0 bg-[#4D0000]/70 flex flex-col items-center justify-center text-center text-white px-4">
        <h2 class="text-4xl md:text-5xl font-bold mb-2">What is EduRate?</h2>
        <p class="text-lg opacity-90 max-w-2xl text-yellow-400 font-medium tracking-wide">The official Faculty Evaluation System of PUP Main Campus</p>
    </div>
</section>
...
<div class="bg-gray-50 py-16">
    <div class="container mx-auto px-6 max-w-5xl">
        ...
        <div class="bg-white p-10 rounded-xl shadow-lg mb-10 border-t-4 border-[#800000]">
            <h3 class="text-2xl font-bold text-[#800000] mb-4 text-center md:text-left">About the System</h3>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-8 mb-10">
            <div class="bg-white p-8 rounded-xl shadow-lg border-l-8 border-[#800000] hover:scale-[1.02] transition-transform duration-300">
                <div class="flex items-center space-x-4 mb-4">
                    <div class="text-[#800000] text-3xl">
            ...
            <div class="bg-white p-8 rounded-xl shadow-lg border-l-8 border-yellow-500 hover:scale-[1.02] transition-transform duration-300">
                <div class="flex items-center space-x-4 mb-4">
        ...
        <div class="bg-white p-10 rounded-xl shadow-lg">
            <h3 class="text-2xl font-bold text-[#800000] mb-6">Objectives</h3>
            <ul class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <li class="flex items-start space-x-3">
                    <i class="fa-solid fa-circle-check text-[#800000] mt-1"></i>
                    <span class="text-gray-700">Provide a structured and fair evaluation process for all faculty members</span>
                </li>
                <li class="flex items-start space-x-3">
                    <i class="fa-solid fa-circle-check text-[#800000] mt-1"></i>
                    <span class="text-gray-700">Collect constructive feedback from students to improve teaching quality</span>
                </li>
                <li class="flex items-start space-x-3">
                    <i class="fa-solid fa-circle-check text-[#800000] mt-1"></i>
                    <span class="text-gray-700">Generate comprehensive reports for academic administrators</span>
                </li>
                <li class="flex items-start space-x-3">
                    <i class="fa-solid fa-circle-check text-[#800000] mt-1"></i>
                    <span class="text-gray-700">Ensure anonymity and confidentiality of student responses</span>
                </li>
                <li class="flex items-start space-x-3">
                    <i class="fa-solid fa-circle-check text-[#800000] mt-1"></i>
                    <span class="text-gray-700">Support continuous professional development of faculty members</span>
                </li>
            </ul>
        </div>
    </div>
...
<footer class="bg-[#660000] text-white pt-16 pb-6">
    <div class="container mx-auto px-10 grid grid-cols-1 md:grid-cols-3 gap-12 text-center md:text-left">
        <div>
