...
<nav class="fixed top-0 left-0 right-0 z-50 px-4 md:px-10 py-2 text-white bg-[#660000]/90 backdrop-blur-md shadow-lg transition-all duration-300">
    ...
    <div id="mobile-menu" class="hidden md:hidden absolute top-full left-0 w-full bg-[#660000] border-t border-white/10 shadow-xl flex flex-col p-4 space-y-3">
        ...
        <a href="{{ route('how-it-works') }}" class="block w-full px-4 py-2 rounded-lg bg-white/10 hover:bg-white/20 transition">How It Works</a>
...
<section class="relative h-[40vh] md:h-[45vh] bg-cover bg-center mt-12 md:mt-0" style="background-image: url('{{ asset('images/lagoon.jpg') }}');">
    <div class="absolute inset-0 bg-[#4D0000]/80 flex flex-col items-center justify-center text-center text-white px-6">
        <h2 class="text-3xl md:text-5xl font-bold mb-3 text-white">How It Works</h2>
        <p class="text-base md:text-lg opacity-90 max-w-2xl text-yellow-400 font-medium leading-relaxed">Evaluation process guide for Students and Faculty Members</p>
    </div>
</section>
...
<section class="py-12 md:py-16 bg-gray-50">
    <div class="container mx-auto px-4 md:px-6 max-w-7xl">
        ...
        <div class="text-center mb-10 md:mb-16">
            <h3 class="text-2xl md:text-3xl font-bold text-gray-800">System Workflow</h3>
            <p class="text-gray-500 text-sm mt-2">Find your role below to see how to use the system</p>
        </div>

        <div class="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 relative items-start">
            
            <div class="hidden md:block absolute left-1/2 top-0 bottom-0 w-px bg-gray-200 -translate-x-1/2 z-0"></div>

            <div class="group relative z-10 bg-white p-5 md:p-6 rounded-2xl shadow-sm border border-gray-100 transition-all duration-300 hover:shadow-xl hover:-translate-y-1">
                <div class="flex items-center space-x-3 mb-6 md:mb-8 bg-[#800000]/5 p-4 rounded-lg border-l-4 border-[#800000]">
                    <i class="fa-solid fa-user-graduate text-[#800000] text-xl"></i>
                    <h4 class="text-lg md:text-xl font-bold text-[#800000]">For Students</h4>
                </div>
                <div class="space-y-8 relative pl-2">
                    ...
                    <div class="relative flex items-start space-x-4 md:space-x-6">
                        ...
                        <div class="pb-2">
                            <h5 class="text-base md:text-lg font-bold text-gray-800">Login Account</h5>
                    ...
                    <div class="relative flex items-start space-x-4 md:space-x-6">
                        ...
                        <div class="pb-2">
                            <h5 class="text-base md:text-lg font-bold text-gray-800">Evaluate Faculty</h5>
                    ...
                    <div class="relative flex items-start space-x-4 md:space-x-6">
                        ...
                        <div class="pb-2">
                            <h5 class="text-base md:text-lg font-bold text-gray-800">Submit & Verify</h5>
            ...
            <div class="group relative z-10 bg-white p-5 md:p-6 rounded-2xl shadow-sm border border-gray-100 transition-all duration-300 hover:shadow-xl hover:-translate-y-1">
                <div class="flex items-center space-x-3 mb-6 md:mb-8 bg-yellow-50 p-4 rounded-lg border-l-4 border-yellow-500">
                    <i class="fa-solid fa-chalkboard-user text-yellow-700 text-xl"></i>
                    <h4 class="text-lg md:text-xl font-bold text-yellow-700">For Faculty Members</h4>
                </div>
                <div class="space-y-8 relative pl-2">
                    <div class="absolute left-6 top-4 bottom-4 w-0.5 bg-gray-200"></div>
                    ...
                    <div class="relative flex items-start space-x-4 md:space-x-6">
                        ...
                        <div class="pb-2">
                            <h5 class="text-base md:text-lg font-bold text-gray-800">Access Portal</h5>
                    ...
                    <div class="relative flex items-start space-x-4 md:space-x-6">
                        ...
                        <div class="pb-2">
                            <h5 class="text-base md:text-lg font-bold text-gray-800">View Analytics</h5>
                    ...
                    <div class="relative flex items-start space-x-4 md:space-x-6">
                        ...
                        <div class="pb-2">
                            <h5 class="text-base md:text-lg font-bold text-gray-800">Generate Report</h5>
        ...
        <div class="mt-12 md:mt-16 bg-white p-6 md:p-8 rounded-xl shadow-lg border-t-4 border-[#800000] relative z-20">
            <h3 class="text-lg md:text-xl font-bold text-[#800000] mb-4 md:mb-6 flex items-center">
