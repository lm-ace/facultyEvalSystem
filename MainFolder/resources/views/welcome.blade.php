...
<section class="relative h-screen bg-cover bg-center" style="background-image: url('{{ asset('images/lagoon.jpg') }}');">
    <div class="absolute inset-0 bg-[#4D0000]/70 flex flex-col items-center justify-center text-center text-white px-4">
        ...
        <div class="flex space-x-4">
            <a href="{{ route('login') }}" class="bg-yellow-500 text-[#800000] font-bold py-3 px-8 rounded shadow-lg hover:bg-yellow-400 transition">Start Evaluation</a>
...
<section class="bg-[#800000] py-16 text-center text-white">
    <h2 class="text-3xl font-bold mb-4">Ready to Evaluate?</h2>
    <p class="mb-8 opacity-80">Login to access the evaluation portal. Your feedback helps improve the quality of education at PUP Main Campus.</p>
    <a href="{{ route('login') }}" class="bg-yellow-500 text-[#800000] font-bold py-3 px-10 rounded-lg shadow-md hover:bg-yellow-400 transition duration-300">Login Now</a>
</section>
...
<body class="bg-[#FDFDFC] dark:bg-[#0a0a0a] text-[#1b1b18] flex p-6 lg:p-8 items-center lg:justify-center min-h-screen flex-col">
    ...
    <div class="flex items-center justify-center w-full transition-opacity opacity-100 duration-750 lg:grow starting:opacity-0">
        <main class="flex max-w-[335px] w-full flex-col-reverse lg:max-w-4xl lg:flex-row">
            ...
            <div style="margin-top: 20px; padding: 10px; border: 2px dashed #333;">
                <h2>Git Simulation Test</h2>
                <p>Developer: Leo</p>
                <p>Branch: frontend/leo/git-test</p>
                <p>Status: Successfully pushed to GitHub</p>
            </div>
...
>>>>>>> 02a394c829261096d6374413361708ec6d7546bc
