<div id="addFacultyModal" class="hidden fixed inset-0 z-[60] flex items-center justify-center animate-fade-in bg-black/20 backdrop-blur-sm p-4">
    <div class="bg-white rounded-[2rem] shadow-2xl w-full max-w-lg overflow-hidden transform transition-all relative max-h-[90vh] flex flex-col">
        ...
        <div class="p-6 md:p-8 overflow-y-auto custom-scrollbar">
            <form action="{{ route('admin.faculty.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="flex flex-col items-center mb-6">
                    <div class="relative group cursor-pointer w-24 h-24 md:w-28 md:h-28">
                    ...
                    <h3 class="text-lg md:text-xl font-black text-gray-800 mt-3 tracking-tight">Add New Faculty</h3>
                ...
                <div class="space-y-4">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div class="space-y-1">
                            ...
                            <div class="relative">
                                <input name="faculty_code" class="w-full pl-3 pr-8 py-2.5 bg-gray-50 border border-gray-200 rounded-xl text-sm font-bold focus:border-[#800000] focus:bg-white outline-none transition-all" placeholder="FC-2024-01" required>
                        ...
                        <div class="space-y-1">
                            ...
                            <div class="relative">
                                <input type="email" name="email" class="w-full pl-3 pr-8 py-2.5 bg-gray-50 border border-gray-200 rounded-xl text-sm font-bold focus:border-[#800000] focus:bg-white outline-none transition-all" placeholder="email@pup.edu.ph" required>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div class="space-y-1">
                            ...
                            <input name="first_name" class="w-full px-3 py-2.5 bg-gray-50 border border-gray-200 rounded-xl text-sm font-bold focus:border-[#800000] focus:bg-white outline-none transition-all" required>
                        </div>
                        <div class="space-y-1">
                            <label class="text-[10px] font-bold text-gray-400 uppercase ml-2">Middle Name</label>
                            <input name="middle_name" class="w-full px-3 py-2.5 bg-gray-50 border border-gray-200 rounded-xl text-sm font-bold focus:border-[#800000] focus:bg-white outline-none transition-all">
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                        <div class="md:col-span-2 space-y-1">
                            ...
                            <input name="last_name" class="w-full px-3 py-2.5 bg-gray-50 border border-gray-200 rounded-xl text-sm font-bold focus:border-[#800000] focus:bg-white outline-none transition-all" required>
                        </div>
                        <div class="space-y-1">
                            <label class="text-[10px] font-bold text-gray-400 uppercase ml-2">Suffix</label>
                            <input name="suffix" class="w-full px-3 py-2.5 bg-gray-50 border border-gray-200 rounded-xl text-sm font-bold focus:border-[#800000] focus:bg-white outline-none transition-all" placeholder="Jr.">
                        </div>
                    </div>
                    ...
                    <div class="space-y-1">
                        ...
                        <div class="relative">
                            <input name="contact_no" class="w-full pl-3 pr-8 py-2.5 bg-gray-50 border border-gray-200 rounded-xl text-sm font-bold focus:border-[#800000] focus:bg-white outline-none transition-all" placeholder="0912 345 6789">
...
<div id="editFacultyModal" class="hidden fixed inset-0 z-[60] flex items-center justify-center animate-fade-in bg-black/20 backdrop-blur-sm p-4">
    <div class="bg-white rounded-[2rem] shadow-2xl w-full max-w-lg overflow-hidden transform transition-all relative max-h-[90vh] flex flex-col">
        ...
        <div class="p-6 md:p-8 overflow-y-auto custom-scrollbar">
            <form id="editFacultyForm" method="POST" enctype="multipart/form-data">
                ...
                <div class="flex flex-col items-center mb-6">
                    ...
                    <h3 class="text-lg md:text-xl font-black text-gray-800 mt-3">Edit Profile</h3>
                </div>

                <div class="space-y-4">
                    <div class="space-y-1">
                        <label class="text-[10px] font-bold text-gray-400 uppercase ml-2">Email</label>
                        <input type="email" id="edit-faculty-email" name="email" class="w-full px-3 py-2.5 bg-gray-50 border border-gray-200 rounded-xl text-sm font-bold focus:border-[#800000] focus:bg-white outline-none" required>
                    </div>

                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div class="space-y-1"><label class="text-[10px] font-bold text-gray-400 uppercase ml-2">First Name</label><input id="edit-faculty-fname" name="first_name" class="w-full px-3 py-2.5 bg-gray-50 border border-gray-200 rounded-xl text-sm font-bold focus:border-[#800000]" required></div>
                        <div class="space-y-1"><label class="text-[10px] font-bold text-gray-400 uppercase ml-2">Middle Name</label><input id="edit-faculty-mname" name="middle_name" class="w-full px-3 py-2.5 bg-gray-50 border border-gray-200 rounded-xl text-sm font-bold focus:border-[#800000]"></div>
                    </div>
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                        <div class="md:col-span-2 space-y-1"><label class="text-[10px] font-bold text-gray-400 uppercase ml-2">Last Name</label><input id="edit-faculty-lname" name="last_name" class="w-full px-3 py-2.5 bg-gray-50 border border-gray-200 rounded-xl text-sm font-bold focus:border-[#800000]" required></div>
                        <div class="space-y-1"><label class="text-[10px] font-bold text-gray-400 uppercase ml-2">Suffix</label><input id="edit-faculty-suffix" name="suffix" class="w-full px-3 py-2.5 bg-gray-50 border border-gray-200 rounded-xl text-sm font-bold focus:border-[#800000]"></div>
                    </div>

                    <div class="space-y-1">
                        <label class="text-[10px] font-bold text-gray-400 uppercase ml-2">Contact No.</label>
                        <input id="edit-faculty-contact" name="contact_no" class="w-full px-3 py-2.5 bg-gray-50 border border-gray-200 rounded-xl text-sm font-bold focus:border-[#800000]">
                    </div>
