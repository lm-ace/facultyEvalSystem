...
Route::middleware(['auth'])->prefix('admin')->name('admin.')->group(function () {
    ...
    Route::post('/review-periods/{id}/activate', [ReviewPeriodController::class, 'activate'])->name('review_periods.activate');
    Route::post('/review-periods', [ReviewPeriodController::class, 'store'])->name('review_periods.store');
