    ...
    public function index()
    {
        ...
        if (!$student) {
            return view('student.index', [ // Changed view name to match your file 'student.index'
                'completedCount' => 0, 'totalToEvaluate' => 0, 'percentage' => 0, 'enrolledSubjects' => []
            ]);
        }
        ...
        return view('student.index', compact('completedCount', 'totalToEvaluate', 'percentage', 'enrolledSubjects'));
    }
